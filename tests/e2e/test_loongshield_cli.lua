...
local function assert_scan_header(output, profile)
    local manual_suffix = profile.manual > 0
        and string.format(", %d manual-review item(s)", profile.manual)
        or ""

    assert_contains(output, string.format(
