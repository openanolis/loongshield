...
function test_bundled_profiles_validate_all_level_counts_through_runtime_api()
    local cases = {
        ...
        { path = "profiles/seharden/cis_alinux_3.yml", level = "l1_server", rules = 239, manual = 20 },
        { path = "profiles/seharden/cis_alinux_3.yml", level = "l2_server", rules = 286, manual = 25 },
        { path = "profiles/seharden/cis_alinux_3.yml", level = "l1_workstation", rules = 170, manual = 19 },
        { path = "profiles/seharden/cis_alinux_3.yml", level = "l2_workstation", rules = 187, manual = 19 },
